...
const iconTheme = 'ri-sun-line' // Light Icon
...
sr.reveal('.home__data, .home__social-link, .home__info, ' + 
            '.discover__container, .experience__overlay, .place__card, '+
